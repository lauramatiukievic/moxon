...
export default async function Example() {
  ...
  const { products } = await fetchGraphQL<{ products: { edges: { node: SimpleProduct }[] } }>(print(ProductsQuery));
