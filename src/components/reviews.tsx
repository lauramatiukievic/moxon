    ...
    <div className="lg:col-span-4">
      ...
      <div className="mt-3 flex items-center">
        <div>
            ...
            {[0, 1, 2, 3, 4].map((rating) => (
              <StarIcon
                ...
                className={classNames(
                  product.averageRating && product.averageRating > rating
                    ? 'text-yellow-400'
                    : 'text-gray-300',
                  'size-5 shrink-0',
                )}
          ...
          <p className="sr-only">{product.averageRating} iš 5 žvaigždučių</p>
        </div>
        <p className="ml-2 text-sm text-gray-900"> {product.reviewCount} Atsiliepimai</p>
      </div>
