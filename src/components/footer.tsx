...
const navigation = {
    company: [
      { name: 'Pristatymas', href: '#' },
      { name: 'Apmokėjimas', href: '#' },
      { name: 'Prękių gražinimas', href: '#' },
      { name: 'Press', href: '#' },
    ],
    legal: [
           ...
           <Logo/>
            ...
            <div className=" grid grid-cols-1 gap-8 xl:mt-0">
              <div className="mt-10 sm:mt-0 sm:grid sm:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-sm/6 font-semibold text-gray-900">Įmonė</h3>
                ...
                <div className="mt-10 sm:mt-0 md:mt-0">
                  <h3 className="text-sm/6 font-semibold text-gray-900">Nuostatai</h3>
                  <ul role="list" className="mt-6 space-y-4">
